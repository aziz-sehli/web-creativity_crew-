            ...
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        <img class="rounded-circle" src="my logo" alt="" style="width: 40px; height: 40px;">
                        <div class="bg-success rounded-circle border border-2 border-white position-absolute end-0 bottom-0 p-1"></div>
                    </div>
                    <div class="ms-3">
                        <h6 class="mb-0">SI AZIZ SEHLI</h6>
                        <span>Admin</span>
                    </div>
                </div>
                <div class="navbar-nav w-100">
                    ...
                    <a href="http://localhost/gg/View/admin.php" class="nav-item nav-link active"><i class="fa fa-table me-2"></i>Réclamations</a>
                    <a href="http://localhost/gg/View/reponseadmin.php" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Réponses</a>
                    <a href="http://localhost/gg/View/search.php" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Chercher reclamation</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <form method="POST" action="../View/addreponse.php">
