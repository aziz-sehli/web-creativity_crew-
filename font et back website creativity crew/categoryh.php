...
$categories = $categoyc->getAllcategorys();
...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl py-5">
            ...
            <?php
            // Loop through the fetched categories and generate HTML dynamically
            foreach ($categories as $category) {
                ...
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                    <a class="cat-item rounded p-4" href="">
                        ...
                        <h6 class="mb-3"><?php echo $category['category_name']; ?></h6>
                        <p class="mb-0"><?php echo $category['category_des']; ?> description</p>
                    </a>
                </div>
                <?php
            }
